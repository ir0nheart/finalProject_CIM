package cim.model;
// Google Calendar Sample Code Edited for final CIM Project 
...
public class CalendarSample {
   ...
   */
  private static final String APPLICATION_NAME = "CIM";
  ...
  public static CalendarSample getInstance() {
	if(instance == null)
		instance=new CalendarSample();
	return instance;
}

private static CalendarSample instance = null;
...
//  }
  ...
  public Calendar addCalendar(String calendarName) throws IOException {
...
//    return result;
//  }
//  public void addAppointmentEvent(String calendarId,String startDate,String endDate, String summary,String link,String location) throws IOException {
...
//  }
  ...
  public void addAppointmentAsEvent(String calendarId,Event evt) throws IOException {
	  Event result = client.events().insert(calendarId, evt).execute();
	  View.display(result);
