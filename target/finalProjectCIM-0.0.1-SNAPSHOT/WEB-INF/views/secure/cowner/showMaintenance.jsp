...
<div class="main">
	<div class="row">
		<div class="text-center">
			<h1>List of Maintenance Companies</h1>
		</div>
		<table class="table table-hover">
				...
				<c:forEach var="maintenance" items="${maintenanceCompanyList}">
				<tr>
					<td>${maintenance.maintenanceCompanyName }</td>
					<td>${maintenance.maintenanceCompanyContact }</td>
					<td colspan="2">${maintenance.maintenanceCompanyAddress}</td>
					<td><a href="appointmentFrom?id=${maintenance.maintenanceCompanyId}">Check Schedule<span stype="style="font-size:16px;" class="pull-right hidden-xs showopacity fa fa-calendar"></span></a></td>
				</tr>
			</c:forEach>
